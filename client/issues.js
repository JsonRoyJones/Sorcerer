const result = {
  items: [
    ...
    },
    {
      ...
      number: 10825,
      title:
        'Allow accessing events registered via `vm.$on(...)` via a property, similar to `$listeners`',
      user: {
        login: 'tmorehouse',
        id: 2781561,
...
async function getIssues() {
  // const url = 'https://github.com/JsonRoyJones/Sourcerer/blob/master/data/issues.json';
  // const headers = {
  ...
  const issuesForm = document.getElementById('divResult');
